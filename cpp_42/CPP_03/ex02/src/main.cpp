...
/*   Updated: 2023/01/20 18:48:21 by loumouli         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main( void )
{
	...
	perso2.guardGate();
	std::cout << std::endl << "Creation FragTrap instance..." << std::endl;
	FragTrap	perso3("Perso3");
	perso3.attack("Perso1");
	perso1.takeDamage(perso3.get_dmg());
